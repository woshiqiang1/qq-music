...
playerPull.addEventListener('click', function () {
    player.show();
});
    ...
    _createClass(Recommend, [{
        ...
        value: function renderRadios(radios) {
            ...
            this.$el.querySelector('.radios .list').innerHTML = radios.map(function (radio) {
                var songUrl = _this2.locallSongList.splice(Math.round(Math.random() * _this2.locallSongList.length), 1);
        ...
        value: function renderPlayLists(playlists) {
            ...
            this.$el.querySelector('.playlists .list').innerHTML = playlists.map(function (list) {
                var songUrl = _this3.locallSongList.splice(Math.round(Math.random() * _this3.locallSongList.length), 1);
